...
import type { SetData } from "@/core/types/workout";
    ...
    <div className="flex items-center gap-1.5">
      ...
      <div className={cn("flex items-center gap-1.5", isBodyweight ? "flex-1" : "flex-1")}>
        ...
        <StepperInput
          ...
          step={1}
          inputMode="numeric"
          onChange={(raw) => onChange({ ...data, reps: raw === "" ? 0 : parseInt(raw, 10) || 0 })}
          onStep={(delta) =>
            onChange({
              ...data,
              reps: Math.max(0, Math.min(9999, (Number(data.reps) || 0) + delta)),
            })
          }
        />
