...
import type { WeeklyVolumeComparison } from "@/server/services/progressService";
  ...
  if (noData) {
    return (
      <div className="bg-white dark:bg-zinc-900 rounded-2xl p-4 border border-zinc-100 dark:border-zinc-800 flex flex-col justify-center">
        ...
        <div className="text-sm text-zinc-400 dark:text-zinc-500 mt-2">Noch nicht genug Daten</div>
      </div>
    );
  }
