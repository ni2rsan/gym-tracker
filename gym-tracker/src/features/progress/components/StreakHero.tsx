...
function getMilestoneParams(totalTracked: number) {
  ...
  const ringProgress =
    nextMilestone && prevMilestone != null
      ? (totalTracked - prevMilestone) / (nextMilestone - prevMilestone)
      : nextMilestone
        ? totalTracked / nextMilestone
        : 1;
    ...
    <div className="bg-gradient-to-br from-slate-700 via-slate-800 to-zinc-900 dark:from-slate-800 dark:via-slate-900 dark:to-zinc-950 rounded-2xl p-5">
      <div className="flex flex-col sm:flex-row items-center gap-5">
            ...
            <div className="relative w-32 h-32">
              ...
              <div className="w-full h-full overflow-hidden rounded-full">
                {!badgeImgError ? (
                  ...
                  <span className="text-5xl leading-none flex items-center justify-center w-full h-full">
                    🏅
                  </span>
                )}
              </div>
        ...
        <div className="flex-1 min-w-0 w-full">
          {/* Milestone text */}
          <p className="text-sm text-white/90 mb-3">{getMilestoneText(totalTracked)}</p>
