...
} from "@/core/domain/badgeLayout";
import { StreakHero } from "./StreakHero";
import { VolumeCasketCard } from "./VolumeCasketCard";
import { SocialCard } from "./SocialCard";
import dynamic from "next/dynamic";
const SpecialsCard = dynamic(() => import("./SpecialsCard").then((m) => m.SpecialsCard), {
  ssr: false,
  loading: () => (
    <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-100 dark:border-zinc-800 h-48 animate-pulse" />
  ),
});
