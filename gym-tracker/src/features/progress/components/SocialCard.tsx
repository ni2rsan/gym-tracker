...
const FRIEND_BADGES: SocialBadge[] = [
  ...
  },
  {
    ...
    type: "friends",
    headline:
      "Ten people watching you grow. Don't let them down. More importantly, don't let yourself down.",
    subtext:
...
const FISTBUMP_BADGES: SocialBadge[] = [
  ...
  },
  {
    ...
    type: "fistbumps",
    headline:
      "Ten people took a moment to recognise your effort. You're doing something worth noticing.",
    subtext:
  ...
  },
  {
    ...
    type: "fistbumps",
    headline:
      "Thirty fistbumps. You're not just lifting for yourself anymore. You're inspiring people without even trying.",
    subtext:
...
export function SocialCard({ friendCount, fistbumpCount, layout }: SocialCardProps) {
  ...
  const lastFistbump =
    [...FISTBUMP_BADGES].reverse().find((b) => fistbumpCount >= b.threshold) ?? null;
                  ...
                  return achieved ? (
                    ...
                    >
                      <div className="relative w-full aspect-square scale-[2.62] sm:scale-[1.75]">
                        ...
                        <span className="sparkle sparkle-d1" style={{ top: "44%", left: "28%" }}>
                          ✦
                        </span>
                        <span
                          className="sparkle sparkle-d2"
            ...
            <div className="px-4 pb-3 pt-1">
              <div className="flex items-center gap-2">
                <div className="w-[72px] h-[72px] sm:w-[84px] sm:h-[84px] shrink-0">
                  {lastFriend ? (
                    <img
                      src={`/social/${lastFriend.key}.png`}
                      alt={lastFriend.label}
                      className="w-full h-full object-contain"
                    />
                  ) : (
                ...
                <div className="w-[72px] h-[72px] sm:w-[84px] sm:h-[84px] shrink-0">
                  {nextFriend ? (
                    <img
                      src={`/social/${nextFriend.key}.png`}
                      alt={nextFriend.label}
            ...
            <div className="px-0 pt-3 pb-2">
              <div className="flex items-center gap-1.5 mb-2 px-2">
                <img
                  ...
                  alt=""
                  className="h-3.5 w-3.5 object-contain fb-icon"
                />
                <span className="text-[10px] font-semibold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">
                  Fist Bumps
                </span>
            ...
            <div className="px-4 pb-4 pt-1">
              <div className="flex items-center gap-2">
                <div className="w-[72px] h-[72px] sm:w-[84px] sm:h-[84px] shrink-0">
                  {lastFistbump ? (
                    <img
                      src={`/social/${lastFistbump.key}.png`}
                      alt={lastFistbump.label}
                      className="w-full h-full object-contain"
                    />
                  ) : (
                    <div className="w-full h-full rounded-full bg-zinc-100 dark:bg-zinc-800" />
                ...
                <div className="w-[72px] h-[72px] sm:w-[84px] sm:h-[84px] shrink-0">
                  {nextFistbump ? (
                    <img
                      src={`/social/${nextFistbump.key}.png`}
                      alt={nextFistbump.label}
                      className="w-full h-full object-contain opacity-40 grayscale"
                    />
                  ) : (
                    <div className="w-full h-full flex items-center justify-center">
