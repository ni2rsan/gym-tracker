...
import { ExerciseIcon } from "@/features/workout/components/ExerciseIcon";
...
function IconGridIllustration() {
  ...
  const exercises: {
    name: string;
    muscleGroup: "UPPER_BODY" | "LOWER_BODY" | "BODYWEIGHT" | "CARDIO";
    done: boolean;
  }[] = [
    ...
    <div className="w-full max-w-[260px] rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-950 overflow-hidden shadow-sm">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950">
        ...
        <div className="text-center">
          <p className="text-[7px] text-zinc-400 uppercase tracking-wide font-medium">
            Tracking Mode
          </p>
          <p className="text-[9px] font-semibold text-zinc-900 dark:text-white">Upper Body</p>
        </div>
        <div className="flex items-center gap-1 text-[9px] text-zinc-400">? &nbsp; ✕ Exit</div>
      </div>
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900">
        ...
        <div className="rounded border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-1.5 py-0.5 text-[8px] text-zinc-500">
          2:00 ▾
        </div>
      </div>
      {/* Icon grid */}
      <div className="grid grid-cols-3 gap-x-3 gap-y-3 p-3">
        {exercises.map(({ name, muscleGroup, done }) => (
          <div key={name} className="flex flex-col items-center gap-1">
            <div
              className={`relative w-11 h-11 rounded-full flex items-center justify-center ${done ? "bg-amber-100 dark:bg-amber-900/50" : "bg-zinc-100 dark:bg-zinc-800 ring-2 ring-zinc-200 dark:ring-zinc-700"}`}
            >
              <ExerciseIcon name={name} muscleGroup={muscleGroup} className="h-5 w-5" />
              {done && (
                <div className="absolute -top-0.5 -right-0.5 w-4 h-4 rounded-full bg-emerald-500 border-2 border-white dark:border-zinc-950 flex items-center justify-center text-[7px] font-black text-white">
                  ✓
                </div>
              )}
            </div>
            <span
              className={`text-[7px] font-medium text-center leading-tight line-clamp-2 w-full ${done ? "text-amber-700 dark:text-amber-400" : "text-zinc-500 dark:text-zinc-400"}`}
            >
      ...
      <div className="px-3 pb-3">
        <div className="w-full rounded-xl bg-emerald-500 py-1.5 text-center text-[9px] font-bold text-white">
          Finish
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-col items-center gap-3">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex flex-col items-center gap-1.5">
          <div className="relative w-14 h-14 rounded-full bg-amber-100 dark:bg-amber-900/50 flex items-center justify-center animate-pulse">
            <ExerciseIcon name="BENCH PRESS" muscleGroup="UPPER_BODY" className="h-7 w-7" />
            <div className="absolute -top-0.5 -right-0.5 w-5 h-5 rounded-full bg-emerald-500 border-2 border-white dark:border-zinc-950 flex items-center justify-center text-[9px] font-black text-white">
              ✓
            </div>
          </div>
      ...
      <div className="w-52 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 overflow-hidden shadow-sm">
        ...
        <div className="flex gap-2 px-3 pb-2">
          <div className="flex-1 rounded-lg border border-red-200 dark:border-red-800 py-1 text-[9px] font-semibold text-red-600 text-center">
            Delete
          </div>
          <div className="flex-1 rounded-lg bg-emerald-500 py-1 text-[9px] font-semibold text-white text-center">
            Re-track
          </div>
        </div>
      </div>
  ...
  return (
    <div className="w-full max-w-[230px] flex flex-col items-center gap-2">
      ...
      <div className="w-full flex items-center gap-2 px-2 py-1.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950">
        <div className="w-7 h-7 rounded-lg border border-zinc-200 dark:border-zinc-700 flex items-center justify-center text-[10px] text-zinc-500">
          ←
        </div>
        <div className="flex-1 min-w-0">
          <p className="text-[7px] text-zinc-400 uppercase font-medium tracking-wide">Upper Body</p>
          <p className="text-[9px] font-semibold text-zinc-900 dark:text-white truncate">
            Lat Pulldown
          </p>
        </div>
        <div className="flex items-center gap-0.5">
          <div className="w-7 h-7 rounded-lg flex items-center justify-center text-[9px] text-zinc-400 font-semibold">
            ?
          </div>
          <div className="w-7 h-7 rounded-lg flex items-center justify-center text-[9px] text-zinc-400">
            ✕
          </div>
        </div>
      </div>
      ...
      <div className="w-full space-y-1">
        <div className="flex items-center gap-1.5 mb-1 text-[8px] text-zinc-400 px-1">
          ...
          <div className="rounded border border-zinc-200 dark:border-zinc-700 px-1.5 py-0.5 text-[8px] text-zinc-500">
            Edit
          </div>
        </div>
        {[
          ...
          <div key={s} className="flex items-center gap-1.5 px-1">
            ...
            <div className="flex-1 h-6 rounded border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center text-[8px] text-zinc-700 dark:text-zinc-300">
              {r}
            </div>
            <div className="flex-1 h-6 rounded border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center text-[8px] text-zinc-700 dark:text-zinc-300">
              {w}
      ...
      {/* Next button */}
      <div className="w-full rounded-xl bg-emerald-500 py-2 text-center text-[10px] font-bold text-white">
        Next →
      </div>
    </div>
  );
  ...
  return (
    <div className="w-full max-w-[240px] flex flex-col gap-2">
      ...
      <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700">
        ...
        <div className="rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-2 py-0.5 text-[10px] text-zinc-700 dark:text-zinc-300">
          90s ▾
        </div>
      </div>
      ...
      <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden">
        ...
        <div className="flex items-center gap-1.5 px-3 py-1 text-[9px] text-zinc-400">
          ...
          <div className="flex-1 h-5 rounded bg-zinc-100 dark:bg-zinc-700 flex items-center justify-center text-zinc-400">
            12
          </div>
          <div className="flex-1 h-5 rounded bg-zinc-100 dark:bg-zinc-700 flex items-center justify-center text-zinc-400">
            60
        ...
        <div className="flex items-center gap-1.5 px-3 py-1 text-[9px]">
          <span className="w-8" />
          <span className="flex-1 text-center font-mono text-emerald-600 dark:text-emerald-400 text-xs">
            0:43
          </span>
        ...
        <div className="mx-2 mb-1 flex items-center gap-1.5 px-2 py-1 ring-2 ring-emerald-400 dark:ring-emerald-500 bg-emerald-50 dark:bg-emerald-950/20 rounded-lg">
          <div className="w-8 shrink-0 rounded-md bg-emerald-500 py-0.5 text-[8px] font-bold text-white text-center">
            Done
          </div>
          <div className="flex-1 h-5 rounded bg-zinc-100 dark:bg-zinc-700 flex items-center justify-center text-[8px]">
            10
          </div>
          <div className="flex-1 h-5 rounded bg-zinc-100 dark:bg-zinc-700 flex items-center justify-center text-[8px]">
            65
        ...
        <div className="flex items-center gap-1.5 px-3 py-1.5 opacity-40">
          ...
          <div className="flex-1 h-5 rounded border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center text-[8px]">
            8
          </div>
          <div className="flex-1 h-5 rounded border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center text-[8px]">
            70
