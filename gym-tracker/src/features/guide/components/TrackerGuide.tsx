      ...
      <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-3 shadow-sm">
        ...
        <div className="flex items-center gap-2 mb-2.5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <span className="inline-flex items-center rounded-full bg-amber-100 dark:bg-amber-900/30 px-1.5 py-px text-[9px] font-semibold uppercase tracking-wide text-amber-700 dark:text-amber-400">
              Compound
            </span>
          </div>
          {/* Pin button */}
        ...
        {[
          ...
          <div key={s} className="flex items-center gap-1.5 mb-1">
            ...
            <div className="flex-1 h-6 rounded-md border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center text-[9px] text-zinc-600 dark:text-zinc-300">
              {r}
            </div>
            <div className="flex-1 h-6 rounded-md border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800 flex items-center justify-center text-[9px] text-zinc-600 dark:text-zinc-300">
              {w}
    ...
    <div className="w-full max-w-[220px]">
      <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-3 shadow-sm">
        ...
        <div className="flex items-center gap-1.5 mb-2.5">
          ...
          <button className="ml-auto rounded-md border border-zinc-200 dark:border-zinc-700 px-2 py-0.5 text-[10px] text-zinc-400">
            Edit
          </button>
        </div>
        {/* Set rows */}
...
export const trackerPageSteps: GuideStep[] = [
  {
    title: "Add Exercises",
    description:
      "Tap 'Add' inside any muscle group header to search and add exercises to today's workout. Your selections are saved and pre-fill next time.",
    illustration: <AddExerciseIllustration />,
  },
  {
    title: "Remove an Exercise",
    description:
      "Open any exercise card and tap the red trash icon to remove it from today's workout. This only affects today — it won't delete it permanently.",
    illustration: <RemoveExerciseIllustration />,
  },
  {
    title: "Adjust Set Count",
    description:
      "Use '+Set' and '−Set' in the tracked bar to add or remove sets. Your preferred count is saved and pre-filled the next time you add this exercise.",
