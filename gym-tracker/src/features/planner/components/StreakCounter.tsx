...
const MILESTONE_DATA: MilestoneInfo[] = [
  {
    milestone: 1,
    title: "Rookie",
    headline: "Every champion was once where you are right now.",
    subtext:
      "You found the app. You found the gym. You found muscles you didn't know existed. They found you back. Ow.",
  },
  {
    milestone: 10,
    title: "Brawler",
    headline: "Raw. Unpolished. But you show up and you put in the work. That's enough.",
    subtext:
      "Ten workouts in and you've already developed strong opinions about other people's form. You're not wrong. But maybe keep it to yourself.",
  },
  {
    milestone: 20,
    title: "Grinder",
    headline: "No shortcuts. No excuses. Just you and the work, twenty times over.",
    subtext:
      "You've started meal prepping. You own a shaker bottle. You said \"gains\" out loud unironically this week. There's no going back.",
  },
  {
    milestone: 30,
    title: "Gym Rat",
    headline: "Thirty sessions in. The iron is familiar now. You are getting harder to stop.",
    subtext:
      "You have a favourite machine. You have a least favourite machine. You have feelings about both. The gym staff knows your order.",
  },
  {
    milestone: 50,
    title: "Warrior",
    headline: "Fifty workouts. Most people never get here. You made it look like a habit.",
    subtext:
      "Fifty sessions. You've sweated through that shirt so many times it now goes to the gym on its own. People ask you for advice. You give it. Confidently.",
  },
  {
    milestone: 60,
    title: "Gladiator",
    headline: "Sixty sessions in the arena. You don't wait for the fight to come to you.",
    subtext:
      "Sixty workouts. You refer to the gym as \"the arena\" now. Your colleagues have noticed something different about you. They can't quite place it. It's the traps.",
  },
  {
    milestone: 75,
    title: "Spartan",
    headline: "Seventy-five workouts. Discipline over motivation. Every single time.",
    subtext:
      "You trained on your birthday. You trained on a public holiday. You trained during a thunderstorm. At this point the gym should be paying you rent.",
  },
  {
    milestone: 100,
    title: "Legend",
    headline: "One hundred workouts. The bar bends. You don't.",
    subtext:
      "One hundred workouts. New members point at you and whisper. Old members nod at you with respect. The dumbbells are afraid of you. As they should be.",
  },
];
  ...
  const detailOverlay = active && (
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">{active.subtext}</p>
        <button
          onClick={() => setActive(null)}
                  ...
                  <img
                    ...
                    style={
                      unlocked
                        ? {
                            filter:
                              "drop-shadow(0 0 4px rgba(251,191,36,0.6)) drop-shadow(0 0 8px rgba(245,158,11,0.3))",
                          }
                        : undefined
                    }
                  />
              ...
              <div key={milestone} className="flex flex-col items-center gap-1">
                {unlocked ? (
                  <div className="relative w-32 h-32">
                    ...
                    <span className="sparkle sparkle-d1" style={{ top: 36, left: 20 }}>
                      ✦
                    </span>
                    <span className="sparkle sparkle-d2" style={{ bottom: 24, right: 22 }}>
                      ✦
                    </span>
                    <button
                      onClick={(e) => {
            ...
            return (
              <div key={group}>
                ...
                <div className="flex items-center gap-1.5 mb-2">
                  ...
                  <span
                    className={cn("text-[10px] font-bold uppercase tracking-widest", meta.color)}
                  >
                    {meta.label}
                  </span>
                </div>
  ...
  return (
    <div className="bg-amber-50 dark:bg-zinc-900/80 rounded-2xl border border-amber-200 dark:border-amber-900/40 py-3 px-5 space-y-3">
      ...
      <div className="border-t border-amber-200 dark:border-amber-900/40 pt-3 space-y-2">
        ...
        {errorMsg && <p className="text-[10px] text-red-500 dark:text-red-400">{errorMsg}</p>}
...
export function StreakCounter({ streakData }: StreakCounterProps) {
  const { generalStreak, sorryUsed, sorryMax, canEditSorryMax } = streakData;
  ...
  return (
    <div className="mt-6 space-y-3">
      <FooterCard
        ...
        sorryUsed={sorryUsed}
        sorryMax={sorryMax}
        canEditSorryMax={canEditSorryMax}
      />
    </div>
  );
}
