        ...
        {cells.map((date, i) => {
          ...
          return (
            ...
            >
              {showSorryBadge && (
                <span
                  className="absolute top-0.5 right-0.5 w-2.5 h-2.5 rounded-full border border-amber-400 bg-amber-100 dark:border-amber-500 dark:bg-amber-900/40 flex items-center justify-center pointer-events-none font-bold text-amber-600 dark:text-amber-400"
                  style={{ fontSize: "6px" }}
                >
                  S
                </span>
