...
import { BLOCK_COLORS, BLOCK_BORDER_COLORS } from "@/core/constants/exercises";
        ...
        {cells.map((dayNum, i) => {
          ...
          return (
            ...
            >
              {showSorryBadge && (
                <span
                  className="absolute top-0 right-0 rounded-full border border-amber-400 bg-amber-100 dark:border-amber-500 dark:bg-amber-900/40 flex items-center justify-center pointer-events-none font-bold text-amber-600 dark:text-amber-400"
                  style={{ fontSize: "4px", width: "7px", height: "7px" }}
                >
                  S
                </span>
              )}
                            ...
                            showCheck
                              ...
                              : missed
                                ? cn(
                                    ...
                                    BLOCK_BORDER_COLORS[b.blockType as BlockType] ??
                                      "border-zinc-400",
                                  )
                        ...
                        >
                          ...
                          {missed && (
                            <span
                              ...
                              style={{ fontSize: "5px", color: "#cc0000" }}
                            >
                              ✗
                            </span>
                          )}
