        ...
        return (
          <div key={monthKey}>
            <h3
              ...
              className="text-sm font-semibold text-zinc-500 dark:text-zinc-400 mb-2 uppercase tracking-wide"
            >
              {MONTH_NAMES[m - 1]} {y}
            </h3>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span
                        suppressHydrationWarning
                        className="text-sm text-zinc-600 dark:text-zinc-300 w-28 shrink-0"
                      >
