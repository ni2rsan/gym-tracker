  ...
  const rows: { key: keyof typeof settings; label: string; description: string }[] = [
    {
      key: "shareWeight",
      label: "Body Weight",
      description: "Share your current weight with friends",
    },
    {
      key: "shareBodyFat",
      label: "Body Fat %",
      description: "Share your body fat percentage with friends",
    },
    {
      key: "sharePRs",
      label: "Personal Records",
      description: "Share your exercise PRs with friends",
    },
  ];
